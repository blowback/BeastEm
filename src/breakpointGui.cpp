...
void BreakpointGui::drawBreakpoints() {
  ...
  gui->printKeyHint(GUI::COL4, 34, menuColor, "W: Watchpoints");
  gui->printKeyHint(GUI::COL5, 34, menuColor, "G: Trace log");
  ...
  if (bpCount >= DebugManager::MAX_BREAKPOINTS) {
    ...
    gui->printKeyHint(GUI::COL1, GUI::END_ROW - GUI::ROW_HEIGHT*2, menuColor, "A: Add");
    gui->printKeyHint(GUI::COL2, GUI::END_ROW - GUI::ROW_HEIGHT*2, menuColor, "C: Cpu.pc 0x%04X", cpuAddress);
    if (listingAddress != cpuAddress) {
      gui->printKeyHint(GUI::COL3, GUI::END_ROW - GUI::ROW_HEIGHT*2, menuColor, "Y: Listing 0x%04X", listingAddress);
    }
    gui->printKeyHint(GUI::COL5, GUI::END_ROW - GUI::ROW_HEIGHT*2, menuColor, "S: BDOS");
  }
  gui->printKeyHint(GUI::COL1, GUI::END_ROW, menuColor, "Space: Toggle");
  gui->printKeyHint(GUI::COL2, GUI::END_ROW, menuColor, "Enter: Edit");
  gui->printKeyHint(GUI::COL3, GUI::END_ROW, menuColor, "N: Name");
  gui->printKeyHint(GUI::COL4, GUI::END_ROW, menuColor, "D: Delete");
...
void BreakpointGui::drawWatchpoints() {
  ...
  gui->printKeyHint(GUI::COL4, 34, menuColor, "B: Breakpoints");
  gui->printKeyHint(GUI::COL5, 34, menuColor, "G: Trace log");
  ...
  if (wpCount >= DebugManager::MAX_WATCHPOINTS && !watchpointEditMode) {
    ...
    gui->printKeyHint(GUI::COL1, GUI::END_ROW, menuColor, "A: Add");
  }
  gui->printKeyHint(GUI::COL2 - gui->getWidthFor(5), GUI::END_ROW, menuColor, "D: Delete");
  gui->printKeyHint(GUI::COL3 - gui->getWidthFor(5), GUI::END_ROW, menuColor, "Space: Toggle");
  gui->printKeyHint(GUI::COL4, GUI::END_ROW, menuColor, "Enter: Edit");
  gui->printKeyHint(GUI::COL5, GUI::END_ROW, menuColor, "ESC: Exit");
}
...
void BreakpointGui::drawTraceLog() {
  ...
  gui->printKeyHint(GUI::COL4, 34, menuColor, "B: Breakpoints");
  gui->printKeyHint(GUI::COL5, 34, menuColor, "W: Watchpoints");
  ...
  gui->printKeyHint(GUI::COL1, GUI::END_ROW, menuColor, "C: Clear");
  gui->printKeyHint(GUI::COL2, GUI::END_ROW, menuColor, "R: Relative");
  gui->printKeyHint(GUI::COL5, GUI::END_ROW, menuColor, "ESC: Exit");
}
